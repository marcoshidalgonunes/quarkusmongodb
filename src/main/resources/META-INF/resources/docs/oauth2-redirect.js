...
function run() {
  ...
  if ((oauth2.auth.schema.get("flow") !== "accessCode" && oauth2.auth.schema.get("flow") !== "authorizationCode" && oauth2.auth.schema.get("flow") !== "authorization_code") || oauth2.auth.code) {
